  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Fundamentos y peligros en las BPM
      ...
      .col-md-12.col-lg-10
        .row.justify-content-center.align-items-center
          ...
          .col-lg-8
            ...
            .bg-color-9.p-4
              p.mb-0 Finalmente, este capítulo establece las bases conceptuales necesarias para abordar los diferentes tipos de peligros que afectan a los alimentos y los mecanismos para prevenirlos. Al dominar estos fundamentos, el aprendiz estará en capacidad de aplicar las BPM de forma consciente, sistemática y permanente, contribuyendo así a una gestión segura y profesional de los procesos de preparación de alimentos.
    ...
    .row.justify-content-center.mb-0
      .col-md-12.col-lg-10
        .p-4.bg-color-14(data-aos="fade-up")
          p.mb-0 En conjunto, el conocimiento y la aplicación de las BPM se consolidan como una herramienta esencial para cualquier persona vinculada al sector gastronómico, sin importar el tipo de establecimiento donde desempeñe sus funciones. Comprender estos principios permite identificar riesgos, corregir prácticas inadecuadas y fortalecer una cultura de prevención que contribuya a proteger la salud pública. Reconocer que las BPM son obligatorias tanto en grandes industrias como en pequeños negocios favorece una gestión sanitaria más responsable y uniforme en todo el país, reduciendo la incidencia de enfermedades transmitidas por alimentos y generando mayor confianza entre los consumidores.
          ...
          table
            ...
            thead
              tr
                th Tipo de peligro
                th Ejemplos comunes
                th Fuentes típicas en cocina colombiana
                th Medida de control preventiva
            tbody
              tr
                td <b>Biológico.</b>
              ...
              tr
                ...
                td Superficies y utensilios mal enjuagados, salsas o rebozados con harina de trigo no declarada, papas verdes o brotadas, frutas y verduras sin lavar adecuadamente.
                td Enjuague completo después de la limpieza, etiquetado claro de alérgenos, inspección y correcto lavado de materias primas, almacenamiento separado de químicos.
              tr
                td <b>Físico.</b>
                td Espinas de pescado, fragmentos de hueso, astillas de vidrio o madera, piedras, piezas de metal, plástico duro.
                td Pescado mal fileteado (para viudo o sudado), carnes con hueso (para asados), envases de vidrio rotos cerca de alimentos, legumbres (lentejas, frijoles) no revisadas o cribadas, utensilios desgastados o rotos.
                td Inspección visual y tacto, uso de tamices o cribas, correcto fileteado y deshuesado, mantenimiento de equipos y envases, protocolo en caso de ruptura de vidrio.
    ...
    .row.justify-content-center.mb-5
      .col-md-12.col-lg-10
        .cajon.bg-color-9.p-4(data-aos="fade-up")
          p.mb-0 Estas prácticas aumentan significativamente el riesgo de propagación de microorganismos patógenos, especialmente en ambientes donde se preparan grandes volúmenes de alimentos, como restaurantes, comedores escolares o industrias alimentarias.
      ...
      .col-md-12.col-lg-12
        .row.justify-content-center.align-items-center
          ...
          .col-lg-9
            ...
            .row.justify-content-center.mb-0
              .col-md-12.col-lg-12
                .row.justify-content-center.align-items-center.bg-color-11.p-4(data-aos="fade-right")
                  .col-lg-9.mb-3.mb-lg-0
