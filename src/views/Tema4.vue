  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      ...
      .col-md-12.col-lg-10(data-aos="fade-up")
        p.mb-0 El dominio de estos procedimientos permite trazar mentalmente un mapa de riesgos asociado a cualquier preparación culinaria. Esta capacidad de análisis facilita reconocer los puntos donde se deben aplicar barreras de protección específicas, tales como el lavado y desinfección de materias primas, la correcta separación entre alimentos crudos y cocidos, el control de temperaturas y la higiene permanente de equipos y utensilios. De este modo, la manipulación de alimentos deja de ser un proceso improvisado y se convierte en una secuencia organizada de acciones preventivas.
    ...
    .row.justify-content-center
      .col-md-12.col-lg-10
        .row.justify-content-center.align-items-center
          .col-lg-9
            p La seguridad alimentaria depende de la correcta articulación de todas las etapas del proceso, ya que cada procedimiento cumple una función preventiva que protege la salud del consumidor y la reputación del establecimiento.
            p.mb-3(data-aos="fade-right") Estos lineamientos no limitan la tradición culinaria, sino que la complementan con criterios de higiene y seguridad, permitiendo que platos típicos conserven su sabor sin poner en riesgo la salud.
          ...
          .col-md-6.col-lg-3.mb-3.mb-lg-0
            figure
              img(src="@/assets/curso/temas/tema4/img05.png", data-aos="zoom-in")
    ...
    .bg-full-width.bg-fondo-5.tarjeta.mb-5
      .p-4.px-lg-2
        SlyderA(tipo="b").bg-color-white.p-3.p-lg-5.tarjeta
          .row.justify-content-center.align-items-center
    ...
    .row.justify-content-center
      .col-md-12.col-lg-10(data-aos="fade-up")
        .cajon.bg-color-9.p-4
          p.mb-0 En conclusión, identificar correctamente los criterios para la recepción y almacenamiento seguro de materias primas permite establecer una primera barrera de protección contra los peligros biológicos, químicos y físicos. Este proceso no solo garantiza la calidad del producto final, sino que demuestra una actitud profesional y responsable frente a la salud del consumidor. Una cocina que controla lo que entra y cómo lo guarda es una cocina que previene riesgos desde el inicio del proceso productivo.
      ...
      .col-md-12.col-lg-10
        .row.justify-content-center.align-items-center
          .col-lg-9
            ...
            .bg-color-9.p-4
              p.mb-0(data-aos="fade-right") Una de las estrategias más eficaces y fácilmente identificables es la implementación de un <b>Sistema de Código de Colores</b> para utensilios, en especial para tablas de picar y cuchillos. Este sistema traduce el principio abstracto de separación en una acción visual y práctica que evita errores humanos. Cada color se asigna a un tipo específico de alimento: por ejemplo, rojo para carnes rojas crudas, amarillo para aves, azul para pescados y mariscos, verde para frutas y verduras, y blanco para alimentos cocidos o listos para consumir.
                
          .col-lg-3.mb-3.mb-lg-0
            figure
              img(src="@/assets/curso/temas/tema4/img14.png", data-aos="zoom-in")
    ...
    .bg-full-width.bg-fondo-5.tarjeta.mb-5
      .p-4.px-lg-2
        SlyderA(tipo="b").bg-color-white.p-3.p-lg-4.tarjeta
          .row.justify-content-center.align-items-center
            .col-lg-7.mb-4.mb-lg-0
              h4 Control de temperaturas
              p Es vital verificar que los productos lleguen a la temperatura adecuada: productos refrigerados entre 0°C y 4°C, y congelados a -18°C o menos. Cualquier desviación en estos rangos es motivo de rechazo inmediato para garantizar que no se haya roto la cadena de frío.
            .col-md-8.col-lg-5.mb-0.mb-lg-0
              figure
                img(src="@/assets/curso/temas/tema4/img10.png", alt="Acompañamiento").mx-auto
          ...
          table
            ...
            thead
              tr
                th Color
                th Uso designado
                th Alimentos típicos colombianos asociados
    ...
    .row.justify-content-center
      .col-md-12.col-lg-10
        .row.justify-content-center.align-items-center.bg-color-11.p-4(data-aos="fade-left")
          .col-lg-9.mb-3.mb-lg-0
            p.mb-0 Identificar y aplicar este sistema permite crear una barrera visual poderosa. En una cocina donde se prepara una bandeja paisa, por ejemplo, el cocinero debería identificar qué necesita la tabla roja para la carne molida cruda, la verde para el aguacate y la blanca para el chorizo ya cocido. El sistema de colores transforma un protocolo complejo en una acción simple y verificable a simple vista.
          .col-auto.col-lg-3
            figure
      ...
      .col-md-12.col-lg-10
        .row.justify-content-center.align-items-center
          .col-lg-9
            ...
            p.mb-4(data-aos="fade-right") Durante la cocción, los alimentos deben alcanzar temperaturas internas suficientes para eliminar bacterias como Salmonella, E. coli o Listeria. Por ejemplo, las aves y carnes rellenas deben llegar al menos a 74 °C, las carnes rojas a 63-70 °C y los alimentos recalentados a un mínimo de 75 °C. Estas temperaturas deben verificarse con termómetros de uso alimentario y no solo por el aspecto visual del alimento, ya que un color dorado externo no garantiza que el interior esté completamente cocido.
    ...
    //-   .col-md-6.col-lg-6
    //-     .row.justify-content-center
    //-       .col-lg-12.bg-color-1.p-4
    //-         figure
    //-           img(src="@/assets/curso/temas/tema4/img28.png", alt="Carne a la parrilla")
    //-       .col-lg-12.bg-color-1.p-4
    ...
    .row.justify-content-center.mb-5
      .col-md-12.col-lg-10
        ...
        .tabla-a.color-acento-contenido
          table
            caption Nota. Adaptado de Código Internacional Recomendado de Prácticas – Principios Generales de Higiene de los Alimentos (CAC/RCP 35-1993), por el Codex Alimentarius (1993), y del Decreto 3075 (1997).
            thead
              tr
                th Proceso/Producto
                th Temperatura segura
                th Método de verificación
                th Ejemplo de aplicación en cocina colombiana
            tbody
              tr
                td Cocción de aves.
    ...
    .row.justify-content-center.mb-5
      .col-md-12.col-lg-10
        p.mb-0 Identificar estos valores en la tabla dota al aprendiz de criterios objetivos para evaluar la inocuidad de los alimentos, eliminando la dependencia de apreciaciones subjetivas como "se ve cocido" o "huele bien". Este enfoque permite tomar decisiones basadas en ciencia y evidencia, lo que es fundamental en cualquier cocina profesional donde la seguridad alimentaria no puede dejarse al azar.
      ...
      .col-md-12.col-lg-10
        .row.justify-content-center.align-items-center
          ...
          .col-lg-10.mb-4.mb-lg-0
            ...
            p.mb-0 En primer lugar, es necesario reconocer los dos grandes tipos de residuos que se generan en una cocina:
                ...
                SlyderA(tipo="b").bg-color-white.p-3.p-lg-4.tarjeta
                  .row.justify-content-center.align-items-center.p-2
                    .col-lg-12.mb-4.mb-lg-0
                      p.mb-0 La disposición temporal de los residuos implica que los recipientes deben vaciarse de forma periódica, preferiblemente al finalizar cada turno de trabajo o cuando alcancen su capacidad máxima. Los desechos deben trasladarse a un área externa destinada exclusivamente al almacenamiento de basuras. Este espacio debe encontrarse separado de la zona de preparación de alimentos, contar con piso lavable, drenaje adecuado, buena ventilación, estar techado y disponer de contenedores con tapa hermética. Además, debe mantenerse limpio y desinfectado de manera regular.
                  .row.justify-content-center.align-items-center.p-2
                    .col-lg-12.mb-4.mb-lg-0
                      p.mb-0 Identificar un área de basuras sucia, destapada, con presencia de líquidos lixiviados, malos olores o plagas, y ubicada cerca de la recepción o preparación de alimentos, constituye una grave falla en la aplicación de las Buenas Prácticas de Manufactura (BPM). Esta situación incrementa el riesgo de contaminación cruzada y compromete la inocuidad de los productos elaborados.
                  .row.justify-content-center.align-items-center.p-2
                    .col-lg-12.mb-4.mb-lg-0
                      p.mb-0 Finalmente, una correcta gestión de residuos no solo cumple una función sanitaria, sino también ambiental y social. Separar adecuadamente los desechos facilita los procesos de reciclaje y reduce el impacto negativo sobre el entorno. De este modo, el manipulador de alimentos se convierte en un actor clave no solo en la protección de la salud pública, sino también en la promoción de prácticas responsables y sostenibles dentro del establecimiento.
    ...
    .row.justify-content-center.mb-5
      .col-md-12.col-lg-10.mb-3
        p.mb-0 En primer lugar, es fundamental reconocer los materiales aprobados para el contacto con alimentos. El material por excelencia es el acero inoxidable de grado alimenticio (AISI 304), el cual debe poder identificarse en ollas, mesones, recipientes y utensilios por su brillo, resistencia y facilidad de limpieza. Este material es químicamente inerte, no transmite sabores ni olores, no se oxida con facilidad y presenta una superficie lisa que impide la acumulación de microorganismos. Además, su alta durabilidad lo convierte en una opción segura y rentable a largo plazo para los establecimientos de alimentos.
      ...
      .col-md-12.col-lg-10
        .bg-color-9.p-4(data-aos="fade-left")
          p.mb-0 Por el contrario, se deben identificar y evitar materiales que resulten porosos, corrosivos o difíciles de limpiar, ya que facilitan la proliferación bacteriana y el deterioro del alimento. Entre los más comunes se encuentran:
