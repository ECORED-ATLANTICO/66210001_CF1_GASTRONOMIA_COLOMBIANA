      ...
      .col-md-12.col-lg-10
        .row.justify-content-center.align-items-center
          .col-lg-9.mb-3.mb-lg-0
            ...
            p.mb-4(data-aos="fade-right") Durante la cocción, los alimentos deben alcanzar temperaturas internas suficientes para eliminar bacterias como <em>Salmonella</em>, <em>E. coli</em> o <em>Listeria</em>. Por ejemplo, las aves y carnes rellenas deben llegar al menos a 74 °C, las carnes rojas a 68–70 °C y los alimentos recalentados a un mínimo de 75 °C. Estas temperaturas deben verificarse con termómetros de uso alimentario y no solo por el aspecto visual del alimento, ya que un color dorado externo no garantiza que el interior esté completamente cocido.
